<?php /* Smarty version 2.6.20, created on 2014-09-14 12:42:49
         compiled from mailers/web/company_enquiry_notice.html */ ?>
<html>
<head>
...
/mailers/web/images/mail_logo.gif" width="600" height="87" border="0" alt="BUSINESS LOUNGE" style="font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 60px; line-height: 0; color: #ef3c3f; font-weight: bold; display: block" /></td>
                </tr>
                <tr>
                    <td align="left" style="font-size: 20px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #17628c; padding: 15px;" bgcolor="#17628c" colspan="2">
                    	<div style="font-size: 66px; padding: 22px 0 0 0; line-height: 10px; font-weight: bold;">NOTICE</div><div style="font-size: 18px; font-weight: bold; padding: 22px 0 0 0;">ENQUIRY</div>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="font-size: 14px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #ef3c3f; padding: 15px;" bgcolor="#ef3c3f" colspan="2">
                    	<p style="font-weight: bold;">Good day <?php echo $this->_tpl_vars['mailinglist']['mailinglist_name']; ?>
 <?php echo $this->_tpl_vars['mailinglist']['mailinglist_surname']; ?>
</p>
                        <p>You have received an enquiry for your company <b><?php echo $this->_tpl_vars['mailinglist']['company_name']; ?>
</b>, please log on to bizlounge.co.za to view it.</p>
                        <p style="font-weight: bold;">Thank You,<br />The Business Lounge Team</p>
                    </td>
                </tr>
                <tr>
...
"><?php echo $this->_tpl_vars['domain']; ?>
                    ...
                    <td width="196" align="right" style="font-size: 18px; font-weight: bold; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #f16052; padding: 15px;" bgcolor="#f16052">
                    	<a href="http://<?php echo $this->_tpl_vars['domain']; ?>
/" style="color: #FFFFFF;"><img src="http://<?php echo $this->_tpl_vars['domain']; ?>
/mailers/web/images/w_icon.gif" alt="W" width="31" height="31" border="0" /></a> 
						<a href="https://www.facebook.com/bizlounge" style="color: #FFFFFF;"><img src="http://<?php echo $this->_tpl_vars['domain']; ?>
/mailers/web/images/f_icon.gif" alt="f" width="31" height="31" border="0" /></a> 
						<a href="https://twitter.com/bizloungesa" style="color: #FFFFFF;"><img src="http://<?php echo $this->_tpl_vars['domain']; ?>
/mailers/web/images/tw_icon.gif" width="31" height="31" alt="t" border="0" /></a> 
						<a href="http://www.linkedin.com/company/business-lounge-sa" style="color: #FFFFFF;"><img src="http://<?php echo $this->_tpl_vars['domain']; ?>
/mailers/web/images/in_icon.gif" alt="in" width="31" height="31" border="0" /></a> 
						<a href="http://gplus.to/bizlounge" style="color: #FFFFFF;"><img src="images/g_icon.gif" width="28" height="31" alt="G" border="0" /></a> 
                    </td>
                </tr>
            </table>
		</td>
...
">Click here to view this mailer on a browser and also if you cant view it properly</a>
