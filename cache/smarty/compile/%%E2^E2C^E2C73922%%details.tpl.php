<?php /* Smarty version 2.6.20, created on 2014-09-14 12:42:52
         compiled from companies/details.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	<div class="row">
    	<div class="col-xs-12 col-md-8 db-gutter-right">
			...
			<div class="tenderboxe eachbox">
                ...
                <!-- //// FOR FEATURED BUSINESS LISTINGS ONLY START /// -->
                <div class="biscover"><img src="http://placehold.it/745x200/ccc" alt="Company Name Here" /></div>
                <div class="bislogo">
                    <img src="http://placehold.it/120x120/ccc" alt="Company Name Here" />
                </div>
                <!-- //// FOR FEATURED BUSINESS LISTINGS ONLY END /// -->
                ...
                <div class="biscopy">
					...
					<p class="bissubhead">Social Media Links</p><!-- //// FOR FEATURED BUSINESS LISTINGS ONLY /// -->
                    <!-- //// FOR FEATURED BUSINESS LISTINGS ONLY /// -->
                    <div class="socbtn bissocbtn">
                        <a href="https://www.facebook.com/companyname" target="_blank" class="fb">Facebook</a>
                        <a href="https://twitter.com/companyname" target="_blank" class="tw">Twitter</a>
                        <a href="http://www.linkedin.com/company/companyname" target="_blank" class="in">LinkedIn</a>
                        <a href="https://plus.google.com/" rel="publisher" target="_blank" class="g">Google+</a> 
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-4 no-gutter-left">
            ...
            <div class="newsbox eachbox no-gutter-left">
                ...
                <div class="bigform bisform">
					...
					<?php else: ?>
                    <form id="bismsg" name="bismsg" role="form" method="POST" action="/companies/details.php">
                       ...
                       <button class="btn" onclick="submitEnquiryForm();">Send Enquiry</button>
...
<?php endif; ?>
			...
			<div class="newsbox eachbox no-gutter-left">
                ...
                <div class="catlist infolist cf">
                    <ul>
                        <li><em>Type of Company:</em> Graphic Design Studio</li>
                        <li><em>Primary Business:</em> design, branding, packaging, corporate identity</li>
                        <li><em>Contact:</em> Jeanette</li>
                        <li><em>Tel:</em> +27 11 447 8142</li>
                        <li><em>Fax:</em> 086 510 2068</li>
                        <li><em>Cell:</em> +27 83 267 6397</li>
                        <li><em>Web Address:</em> <a href="www.creativelicence.co.za" target="_blank">www.creativelicence.co.za</a></li> <!-- //// FOR FEATURED BUSINESS LISTINGS ONLY /// -->
                        <li><em>Physical Address:</em><br />8 Channel House, 6th Street, Parkhurst, Johannesburg, Gauteng, 2193</li> <!-- //// FOR FEATURED BUSINESS LISTINGS ONLY /// -->
                    </ul>
                </div>
			</div>            
            <!-- /// ADVERT BOX /// -->
