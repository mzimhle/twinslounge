<?php /* Smarty version 2.6.20, created on 2014-09-24 09:37:11
         compiled from administration/company/view/service.tpl */ ?>
...
" title="Details">Details</a></li>
			<li><a href="/administration/company/view/category.php?code=<?php echo $this->_tpl_vars['companyData']['company_code']; ?>
" title="Category">Category</a></li>
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/administration/company/view/service.php?code=<?php echo $this->_tpl_vars['companyData']['company_code']; ?>
...
<?php echo '&update_code="+id+"&companyservice_primary="+primary + "&companyservice_name="+$(\'#companyservice_name_\'+id).val(),
				dataType: "json",
