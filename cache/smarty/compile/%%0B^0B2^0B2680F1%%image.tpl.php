<?php /* Smarty version 2.6.20, created on 2014-09-24 11:25:44
         compiled from administration/gallery/image.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'administration/includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/gallery/" title="">Gallery</a></li>
			<li><a href="/administration/gallery/details.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
...
" title="Details">Details</a></li>
	...
	<form id="addForm" name="addForm" action="/administration/gallery/image.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
...
?>
	  <tr>
		<td><a target="_blank" href="<?php echo $this->_tpl_vars['item']['galleryimage_path']; ?>
	  ...
	  <?php endif; unset($_from); ?>  
		...
		<tr>
			<td colspan="3">
				...
				<?php if (isset ( $this->_tpl_vars['errorArray']['galleryimage_description'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['galleryimage_description']; ?>
</span><?php endif; ?>
			</td>
			<td>
