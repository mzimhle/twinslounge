<?php /* Smarty version 2.6.20, created on 2014-09-14 12:16:50
         compiled from administration/companies/view/category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'administration/companies/view/category.tpl', 75, false),)), $this); ?>
...
" title="Details">Details</a></li>
			...
			<li><a href="/administration/companies/view/service.php?code=<?php echo $this->_tpl_vars['companyData']['company_code']; ?>
" title="Services">Services</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/administration/companies/view/category.php?code=<?php echo $this->_tpl_vars['companyData']['company_code']; ?>
